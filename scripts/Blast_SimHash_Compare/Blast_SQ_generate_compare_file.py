...
porgess = 0
csv_string = 'window_size,hash,ham_distance,similarity,error,blast_output'
...
for blast_hit in blast_hits_list:
    ...
    for hash_hit in hash_hits_list:
        ...
        if blast_string_chunks[0] == hash_string_chunks[0] and blast_string_chunks[1] == hash_string_chunks[1]:
            ...
            csv_string = '{window_size},{hash},{ham_distance},{similarity},{error:2f},{blast_output}'.format(
